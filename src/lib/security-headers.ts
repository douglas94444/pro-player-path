...
const CSP = [
  ...
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://graph.facebook.com https://connect.facebook.net https://api.mercadopago.com https://*.mercadopago.com https://*.lovable.app https://*.lovable.dev",
